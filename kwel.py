...
button_percentage = tk.Button(master=frame, text='%', fg="white", padx=15,
                         pady=5, bg="gray", borderwidth=10, font=('hevatica', 30), width=3, command=percentage)
button_percentage.grid(row=5, column=2, pady=2, sticky="nsew")
button_square = tk.Button(master=frame, text='x²', fg="white", padx=15,
                         pady=5, bg="gray", borderwidth=10, font=('hevatica', 30), width=3, command=square)
button_square.grid(row=5, column=1, pady=2, sticky="nsew")
